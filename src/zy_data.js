...
const userImgData = {
    ...
    public:{/*全局规范*/
        ...
        framesize:{//将画布按竖版（含方版）和横板分6级，用于对应6级字号,中间值向上取值
            hh:[54,104,168,256,480,512,640,720,870,1080],//竖版以宽为极值
            ww:[50,70,120,180,220,280,320,380,440,520],//横版以高为极值
        },
    },
    style:{
        title:{/*默认样式*/
    ...
    zy:[/*有哪些资源位*/
        {
            img:{name:"测试1",w:1280,h:720,s:"300k",type:"jpg",d:0.1,view:false,safa:[]},
